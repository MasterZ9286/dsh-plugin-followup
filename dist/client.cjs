...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      `.dsh-followup-send{border:0;border-radius:7px;padding:5px 12px;background:var(--dsw-static-deepseek-500,#4176e6);color:#fff;font:inherit;font-size:12px;cursor:pointer;appearance:none}`,
